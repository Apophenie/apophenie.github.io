...
// Les 25 décalages et leurs 25 variantes justifiées partagent la même famille.
// Une preuve n'accorde pas une seconde place au même réglage du même outil.
test('les césars, justifiés ou non, sont UNE famille, lue sur leur décalage', () => {
  ...
  assert.equal(cesars.length, 50, 'vingt-cinq décalages et leurs variantes justifiées');
