...
export const en = {
  ...
  resultat: {
    ...
    memo: {
      ...
      registre: '?sce!…$…',
      registreTexte: 'staged register, at the head of the approach. When absent it means “plain”: the show has to be asked for, plainness is never written.',
      cible: '?…$…$…',
      cibleTexte: 'the target — digits, or any text —, behind the third segment, in base58 (plain text is read too). When absent it is 666 — the house does not disown itself.',
    ...
    cible: {
      ...
      champLabel: 'Digit sequence, or text, to aim for',
      champInvite: 'any number or text…',
      champAide: 'A sequence of digits, {max} at most, leading zeros included (“007” is not “7”), or any text of {maxTexte} characters at most, aimed at as written, case and accents included.',
      calculer: 'Compute',
      invalide: 'A sequence of digits ({max} at most), or a text of {maxTexte} characters at most.',
      courante: 'Current target: {cible}',
    },
  },

  /* ★ THE EASTER EGG — “cheval sur oiseau = π”. See `src/app/oeuf.js`. The pun
     is French to the bone: a cow is a “bête à pis”, a bird a “bête à ailes”,
     which are heard as beta-pi-L over beta-L. The titles translate; the joke
     stays where it was born. */
  oeuf: {
    titre: 'By phonetic zoology',
    regle: 'A cow is an uddered beast, a bird a winged one: the rest is a matter of hearing.',
