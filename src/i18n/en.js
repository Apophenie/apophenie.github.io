...
export const en = {
  ...
  resultat: {
    ...
    memo: {
      ...
      cible: '#c111!…#…  ·  #c007!…#…',
      cibleTexte: 'target — digits, or a word (#czerg!…#…) —, at the head of the approach. When absent it is 666 — the house does not disown itself.',
    ...
    cible: {
      ...
      champLabel: 'Digit sequence, or word, to aim for',
      champInvite: 'any number or word…',
      champAide: 'A word, or a sequence of digits, {max} characters at most. A word is read without case or accents; digits keep their leading zeros: “007” is not “7”.',
      calculer: 'Compute',
      invalide: 'A word without spaces, or a sequence of digits, {max} characters at most.',
