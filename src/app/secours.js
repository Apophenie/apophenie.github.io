...
export const APPROCHES_ESSAI = [
  ...
  V(4,
    { fr: 'La somme des trois répétitions en A1Z26',
      en: 'The sum of the three repetitions in A1Z26' },
...
export const FRAGMENTS_ESSAI = [
  ...
  { texte: 'fr', methode: { fr: 'A1Z26 puis racine numérique', en: 'A1Z26 then digital root' },
