...
export const APPROCHES_ESSAI = [
  ...
  V(4,
    { fr: 'La somme des trois répétitions en numérologie latine',
      en: 'The sum of the three repetitions in Latin numerology' },
...
export const FRAGMENTS_ESSAI = [
  ...
  { texte: 'fr', methode: { fr: 'numérologie latine puis racine numérique', en: 'Latin numerology then digital root' },
